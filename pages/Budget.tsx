...
const budgets = [
  ...
  { id: 3, category: 'Transportation', allocated: 200, spent: 156.8, color: 'bg-[#b40520]' },
    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-2">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-sm text-[#b40520] font-medium">Edit</button>
        </div>
          ...
          {budgets.map(budget => {
            ...
            return (
              <div key={budget.id} className="banking-card">
                ...
                <div className="h-2 bg-[#b40520] rounded-full overflow-hidden">
      ...
      {/* <section className="px-5 animate-fade-up stagger-3">
        ...
        border-dashed border-gray-200 hover:border-primary hover:bg-[#b40520]/5 transition-all"
        >
