  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-3">
        ...
        <button onClick={handleSignOut} className="w-full cursor-pointer mt-5 flex items-center justify-center gap-3 p-4 rounded-2xl bg-[#b40520] text-white transition-colors hover:bg-[#ef4343]/90">
