        ...
        <>
          ...
          <section className="px-5 animate-fade-up stagger-4">
            <button
              ...
              className="w-full py-4 rounded-2xl bg-[#223e99] text-[#b40520]-foreground font-semibold disabled:opacity-50"
            >
              Continue
            </button>
          </section>
      ...
      {step === 3 && (
        <section className="px-5 animate-fade-up">
          <div className="banking-card text-center py-12">
            ...
            <div className="bg-[#b40520] rounded-xl p-4 mb-6">
            ...
            <Link
              href="/"
              className="inline-block w-full py-4 rounded-2xl bg-white border border-gray-200 font-semibold text-foreground hover:bg-[#b40520] transition-colors"
            >
              Back to Home
            </Link>
          </div>
