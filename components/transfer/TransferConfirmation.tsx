    ...
    <div className="min-h-screen bg-background pb-28">
      <header className="px-5 pt-5 pb-6 animate-fade-up">
        <div className="flex items-center gap-4">
          <button
            onClick={onCancel}
            className="p-2 -ml-2 rounded-full hover:bg-[#b40520] transition-colors"
          >
...
//     <div className="bg-[#b40520]/10 rounded-2xl p-4 flex items-start gap-3">
//       <div className="p-1 rounded-full bg-[#b40520]">
...
const ActionButtons = ({
  ...
  <section className="px-5 space-y-3 animate-fade-up stagger-4">
    ...
    <button
      onClick={onCancel}
      disabled={isProcessing}
      className="w-full py-4 cursor-pointer rounded-2xl bg-[#b40520]/70 text-white font-semibold text-lg transition-colors hover:bg-[#b40520] active:scale-[0.98] disabled:opacity-50"
    >
      Cancel
    </button>
  </section>
