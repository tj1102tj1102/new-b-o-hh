...
const DebitCard = ({ cardNumber = '**** **** **** 7890', cardHolder = 'JAMES ANDERSON', expiryDate = '12/28', cvv = '***' }: DebitCardProps) => {
  ...
  return (
    <div
      className="bg-[#330209] relative shadow-sm rounded-2xl p-6 pt-4 cursor-pointer transition-all duration-300 ease-out transform-style-3d"
      style={{
    ...
    >
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex items-center gap-2">
          <Image src="https://i.postimg.cc/SRhTY3kD/BAC-e7995069.png" width={72} height={72} className="" alt="logo" />
        </div>
